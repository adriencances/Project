...
#CARD_PAIRS = [CARDS[i] + " " + CARDS[j] for i in range(52) for j in range(i + 1, 52)]
#FIVE_CARD_SETS = [" ".join([CARDS[i], CARDS[j], CARDS[k], CARDS[l], CARDS[m]])
#                  for i,j,k,l,m in it.combinations(range(52), 5)]
